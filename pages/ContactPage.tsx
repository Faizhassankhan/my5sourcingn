                    ...
                    <div className="text-left">
                        ...
                        <div className="space-y-4" data-aos="zoom-in" data-aos-delay="400">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <span>(UK) +44 7404 662835</span>
                            </div>
                            <div className="flex items-center gap-4">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <span>(PK) +92 321 8277463</span>
                            </div>
                            <div className="flex items-center gap-4">
                                ...
                                <a href="https://wa.me/923218277463" target="_blank" rel="noopener noreferrer" className="hover:text-amber-400 transition-colors">Chat on WhatsApp</a>
                            </div>
                            <div className="flex items-start gap-4">
                                ...
                                <span>Plot 4/1 sector 23 korangi industrial area,<br />karachi pakistan</span>
                            </div>
                        </div>
                    </div>
